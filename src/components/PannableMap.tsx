...
// native dependencies (the SDK-54-paired react-native-reanimated release
// pulls in a separate worklets package and a New Architecture-only build
// step that can't be verified without a real device/simulator here).
// minimumZoomScale is computed from the actual viewport size so "zoomed
// all the way out" always shows the whole map; the first layout pass
// scrolls to center initialFocus (the town hall) without animating.
